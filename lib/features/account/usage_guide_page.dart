      ...
      body: ListView(
        ...
        children: const [
          ...
          _GuideSection(
            ...
            title: 'Hubungkan ke Tata Usaha',
            text: 'Buka tab Akun lalu pilih Scan QR Tata Usaha. Scan QR dari website TU saat terhubung internet. Setelah berhasil, aplikasi hanya menerima surat dari akun TU tersebut.',
          ),
          _GuideSection(
            number: '02',
            icon: Icons.notifications_active_outlined,
            title: 'Terima tugas baru',
            text: 'Saat surat baru dari Tata Usaha pasangan masuk, notifikasi akan muncul. Buka tab Aktivitas untuk melihat daftar surat yang tersedia.',
          ),
          _GuideSection(
            number: '03',
          ...
          _GuideSection(
            ...
            text: 'Pairing QR wajib online. Setelah terhubung, tugas dan bukti tetap dapat disimpan offline lalu otomatis dikirim saat internet kembali.',
          ),
          SizedBox(height: 8),
          _OfflineTip(),
          SizedBox(height: 16),
